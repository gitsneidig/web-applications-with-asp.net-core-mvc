...
namespace BethanysPieShop.Models
{
    public class MockPieRepository : IPieRepository
    {
        ...
        public IEnumerable<Pie> AllPies => 
            ...
            new Pie { PieId = 3, Name="Rhubarb Pie", Price=15.99M, ShortDescription="Rhubarb Pie Short", LongDescription="Rhubarb Pie Long", Category = _categoryRepository.AllCategories.ToList()[2] },
            new Pie { PieId = 4, Name="Pumpkin Pie", Price=12.99M, ShortDescription="Pumpkin Pie Short", LongDescription="Pumpkin Pie Long", Category = _categoryRepository.AllCategories.ToList()[3] }
            };
